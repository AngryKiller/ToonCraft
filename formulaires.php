    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Connexion</h4> </div>
            <div class="modal-body">
				...
				if($apiMail == 1) { ?>
                    <p>
                        <div class="alert alert-warning" style="text-align: center;">Un problème de connexion/inscription ? Mail d'inscription pas reçu ? Envoyer à cette adresse email votre problème :
                            <B><center>Indisponible</center></B> </div>
                    </p>
                    <?php } ?>
                        <div class="row"> <img class="profile-img" src="http://api.craftmywebsite.fr/skin/face.php?u=<?php echo $_COOKIE['pseudo']; ?>&s=128&v=front" alt="">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <form class="form-signin" role="form" method="post" action="?&action=passRecover" style="max-width: none;">
                        <div class="col-md-8">
                            <input type="email" name="email" class="form-control" id="EmailRecoverForm" placeholder="Email" required autofocus> </div>
                        <div class="col-md-4">
                ...
                <div class="modal-body">
                    <form role="form" method="post" action="?&action=inscription">
                        <?php if($apiMail == 1) { ?>
                            <center>
                                <p>
                                    <div class="alert alert-warning" style="text-align: center;">Veuillez mettre une adresse email correct, car une demande de confirmation du compte sera demandé ! Vérifier dans les spams/courriers indésirables.</div>
                                </p>
                            </center>
                            <?php } ?>
                                <div class="form-group">
                                    <label for="PseudoInscriptionForm">Pseudo</label>
                                    <input type="text" name="pseudo" class="form-control" id="PseudoInscriptionForm" placeholder="Votre pseudo exact In-Game"> </div>
                                <div class="form-group">
                                    <label for="EmailInscriptionForm">Email</label>
                                    <input type="email" name="email" class="form-control" id="EmailInscriptionForm" placeholder="Merci d'entrer une adresse email valide"> </div>
                                <div class="form-group">
                                    <label for="MdpInscriptionForm">Mot de passe</label>
                                    <input type="password" name="mdp" class="form-control" id="MdpInscriptionForm" placeholder="Votre mot de passe"> </div>
                                <div class="form-group">
                                    <label for="MdpConfirmInscriptionForm">Mot de passe</label>
                                    <input type="password" name="mdpConfirm" class="form-control" id="MdpConfirmInscriptionForm" placeholder="Confirmez-le"> </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="souvenir" checked> S'inscrire à la newsletter. </label>
                                </div>
                                <div class="row" style="margin-left: -10px;">
                                    <div class="col-md-6">
                                        <label>Captcha:</label>
                                        <input type='text' name='CAPTCHA' placeholder='captcha' class="form-control" /> </div>
                                    <div class="col-md-6"> <img id='captcha' src='include/purecaptcha/purecaptcha_img.php?t=login_form' style="width: 100%;height: 100px;" />
                                        <br/> </br>
