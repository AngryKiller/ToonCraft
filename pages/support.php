            ...
            <table class="table">
                ...
                <?php $j = 0;
                    ...
                    <tr>
                        ...
                        <td> <a class="btn btn-warning btn-block <?php if($j%2 == 0) echo 'StyleSaut'; ?>" data-toggle="modal" data-target="#<?php echo $tickets['id']; ?>Slide">​Voir</a> </td>
                        <td>
                            <?php
                        ...
                        <div class="modal-dialog modal-support">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    </p> <span class="label label-primary pull-right">Ticket de : <img src="http://api.craftmywebsite.fr/skin/face.php?u=<?php echo $tickets['auteur']; ?>&s=16&v=front" alt="none" /> <?php echo $tickets['auteur']; ?></span> </br>
                                    <hr>
                                    <?php
									$commentaires = 0;
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                <div class="ticket-commentaire">
                                                    <div class="left-ticket-commentaire"> <span class="img-ticket-commentaire"><img src="http://api.craftmywebsite.fr/skin/face.php?u=<?php echo $ticketCommentaires[$tickets['id']][$i]['auteur']; ?>&s=32&v=front" alt="none" /></span> <span class="desc-ticket-commentaire">
													<span class="ticket-commentaire-auteur"><?php echo $ticketCommentaires[$tickets['id']][$i]['auteur']; ?></span> <span class="ticket-commentaire-date"><?php echo 'Le ' .$ticketCommentaires[$tickets['id']][$i]['jour']. '/' .$ticketCommentaires[$tickets['id']][$i]['mois']. ' à ' .$ticketCommentaires[$tickets['id']][$i]['heure']. ':' .$ticketCommentaires[$tickets['id']][$i]['minute']; ?></span> </span>
                                                    </div>
                ...
                <div class="panel-body">
                    <form action="?&action=post_ticket" method="post">
                        <div class="form-group">
                            <input type="text" name="titre" class="form-control input-md" id="inputMedium" placeholder="TITRE (Ex: [PvP Box][Bug] Mon jeux crash quand je prends le portail...)"> </div>
                        <br/>
                        <div class="form-group">
                            <textarea name="message" id="textArea" class="form-control" cols="50" rows="11" placeholder="La description détaillée de la proposition ou du probleme..."></textarea>
                            <br/>
                            <button type="submit" class="btn btn-success pull-right" id="buttonsend">Envoyer</button>
                        </div>
                    </form>
                </div>
            </div>
