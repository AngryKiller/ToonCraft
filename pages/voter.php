...
<?php                if(isset($_Joueur_) AND  isset($_GET['player']) AND $_Joueur_['pseudo'] == $_GET['player'] )
                {
    ...
    <div class="tabbable">
        ...
        <?php if(!isset($_GET['player'])) { ?>
            <div class="panel-body" style="background-color:white;padding:10px;">
                ...
                <br>
                <form  id="form-vote" role="form" method="GET" action="index.php">
                    <div style="width:60%;margin-right:20%; margin-left:20%;" >
                        <div class="row">
                            ...
                            <button class="btn btn-success col-12 col-sm-3 col-lg-3 btn-block" onclick="" type="submit" style="margin-top: 15px">Suivant !</button>
                        </div>
                    </div>
                </form>
            </div>
