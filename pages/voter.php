...
<?php // if(!isset($_Joueur_)) echo '<hr><a data-toggle="modal" data-target="#ConnectionSlide" class="btn btn-warning btn-lg" ><span class="glyphicon glyphicon-user"></span> Veuillez vous connecter.</a>';
                ...
                for($i = 0; $i < count($jsonCon); $i++) { ?>
                            ...
                            <?php if(!isset($_GET['player'])) { ?>
                                <div class="panel-body" style="background-color:white;padding:10px;">
                                    <h4 class="panel-title text-center">Veuillez rentrer votre pseudo utilisé en jeu:</h4>
                                    <br>
                                    <form  id="forme-vote" role="form" method="GET" action="index.php">
                                        <div style="width:60%;margin-right:20%; margin-left:20%;" >
                                            <div class="row">
                                                <input type="hidden" name="page" value="voter">
                                                ...
                                                <br>
                                                <center><button class="btn btn-success col-12 col-sm-3 col-lg-3" onclick="" type="submit">Suivant !</button></center>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <table class="table table-hover">
                            ...
                            { ?>
                                <tr>
                                    ...
                                    <td id="nbr-vote-<?php echo $topVoteurs[$i]['pseudo']; ?>">
