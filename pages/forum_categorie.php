<?php if(isset($_GET['id']) AND isset($_Joueur_))
{
    ...
    <div class="container">
		...
		?>
			...
			while($sousforumd = $sousforum->fetch())
			{
				?>
                    <tr>
                        <td>
                            <?php if($sousforumd['img'] == NULL) { ?><a href="<?php echo $_Serveur_['General']['url']; ?>?&page=forum_categorie&id=<?php echo $id; ?>&id_sous_forum=<?php echo $sousforumd['id']; ?>"><i class="fa fa-comment"></i></a>
                                <?php }
					else { ?><a href="<?php echo $_Serveur_['General']['url']; ?>?page=forum_categorie&id=<?php echo $id; ?>&id_sous_forum=<?php echo $sousforumd['id']; ?>"><i class="fa fa-<?php echo $sousforumd['img']; ?>"></a>
                                    <?php }?>
                        </td>
                        <td>
                            <a href="<?php echo $_Serveur_['General']['url']; ?>?&page=forum_categorie&id=<?php echo $id; ?>&id_sous_forum=<?php echo $sousforumd['id']; ?>">
                                <?php echo $sousforumd['nom']; ?>
                            </a>
                        </td>
                        <td>
                            <?php if(isset($sousforumd['description']) AND $sousforumd['description'] != NULL) { ?>
                                <a href="<?php echo $_Serveur_['General']['url']; ?>?&page=forum_categorie&id=<?php echo $id; ?>&id_sous_forum=<?php echo $sousforumd['id']; ?>">
                                    <?php echo $sousforumd['description']; ?>
                                </a>
                                <?php } ?>
                        </td>
                        <?php if($_Joueur_['rang'] == 1)
				{
					?>
                            <td><a href="?action=remove_sf&id_cat=<?php echo $id; ?>&id_sf=<?php echo $sousforumd['id']; ?>">Supprimer le Sous-Forum</a></td>
                            <?php 
				} ?>
                    </tr>
                    <?php 
		...
		{
			?>
                <div class="col-md-offset-8 col-md-4"> <a class="btn btn-primary" role="button" data-toggle="collapse" href="#sous_cat" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <form action="?action=create_sf" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" require class="form-control" name="nom" id="nom" maxlength="40" /> </div>
                                <div class="col-md-6">
                                    <label class="control-label" for="img">FontAwesome : <a href="http://fontawesome.io/icons" target="_blank">http://fontawesome.io/icons</a></label>
                                    <input type="text" maxlength="300" name="img" id="img" class="form-control" /> </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
		...
		if(isset($topicd['id']))
		{
			?>
				...
				while($topicd = $topic->fetch())
				{
					?>
                                <tr>
                                    <td>
                                        <?php if($_JoueurForum_->is_read($topicd['id']))
						{
						...
						else 
						{
							?><i class="fa fa-comment"></i>
                                    ...
                                    <td>
                                        <a href="<?php echo $_Serveur_['General']['url']; ?>?&page=post&id=<?php echo $topicd['id']; ?>">
                                            <?php echo $topicd['nom']; ?>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="<?php echo $_Serveur_['General']['url']; ?>?&page=post&id=<?php echo $topicd['id']; ?>">
                                            <?php echo $topicd['description']; ?>
                                                <?php if($topicd['etat'] == 1) { echo ' Lock '; }?>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="<?php echo $_Serveur_['General']['url']; ?>?&page=post&id=<?php echo $topicd['id']; ?>">
                                            <?php echo $topicd['last_answer']; ?>
                                    </td>
                                </tr>
                                <?php 
				}
			...
			for($i = 1; $i <= $count_topic_nbrOfPages2; $i++)
			{
                ?>
                                    <li>
                                        <a href="?&page=forum_categorie&id=<?php echo $id; ?>&page_topic=<?php echo $i; ?>">
                                            <?php echo $i;
                ?>
                                        </a>
                                    </li>
		...
		{
			?>
                            <div class="alert alert-warning" role="alert"> Aucun sujet n'a été posté :( </div>
                            <?php
		}
	}
	elseif(isset($_GET['id_sous_forum']))
	{
                                        ...
                                        <p>
                                            <ol class="breadcrumb" style="font-size: 30px;">
                                                ...
                                                <li role="presentation">
                                                    <a href="?page=forum_categorie&id=<?php echo $sousforumd['id_categorie']; ?>">
                                                        <?php echo $catdonnees['nom']; ?>
                                                    </a>
                                                </li>
		...
		if(isset($topicd['id']))
		{
					...
					?>
						...
						else 
						{
							?><i class="fa fa-comment"></i>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo $_Serveur_['General']['url']; ?>?&page=post&id=<?php echo $topicd['id']; ?>">
                                                            <?php echo $topicd['description']; if($topicd['etat'] == 1) { echo ' Lock '; }?>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo $_Serveur_['General']['url']; ?>?&page=post&id=<?php echo $topicd['id']; ?>">
			...
			for($i = 1; $i <= $count_topic_nbrOfPages; $i++)
			{
                ?>
                                                    <li>
                                                        <a href="?&page=forum_categorie&id=<?php echo $id; ?>&id_sous_forum=<?php echo $id_sous_forum; ?>&page_sous_forum=<?php echo $i; ?>">
                                                            <?php echo $i;
                ?>
                                                        </a>
                                                    </li>
		...
		{
			?>
                                            <h3>Aucun sujet n'a été posté encore :( </h3>
                                            <?php
		}
	...
	{
		?>
                                                <div class="alert alert-danger" role="alert"> Erreur : Cette page n'existe pas ! </div>
                                                <br/>
                                                <div class="alert alert-info" role="alert"> <a href="<?php echo $_Serveur_['General']['url']; ?>?&page=forum">Revenir à l'index du forum</a></div>
                                                <?php
	}
                                                    ...
                                                    <form action="?&action=create_topic" method="post">
                                                        <p>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="nom" name="nom" placeholder="Le titre de votre topic ici" require /> </div>
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="contenu" class="col-sm-2 form-control-label">Insérez le contenu de votre topic ! ( Max 15 000 caractères )</label>
                                                                <div class="col-sm-10">
                                                                    <textarea id="contenu" name="contenue" max="15000" min="1" class="form-control" rows="10" require></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <center>
...
else
{
	?>
        ...
        <br>
        <div class="container">
            <div class="alert alert-danger" role="alert"> Erreur : Vous devez être connecté pour effectuer cette action </div>
            <br/>
            <div class="alert alert-info" role="alert"> <a href="<?php echo $_Serveur_['General']['url']; ?>?&page=forum">Revenir à l'index du forum</a></div>
        </div>
        <?php
