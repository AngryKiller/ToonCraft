		...
		*/
		...
		?>
			...
			?>
                    ...
                    <td>
                        <?php if($answer_liked['Appreciation'] == 1)
			{
			...
			?>
                    ...
                    <td>
                        <a href="index.php?action=alerts_vu&page=post&id=<?php echo $answer_liked['id_topic']; ?>&page_post=<?php echo $page; ?>&id_answer=<?php echo $answer_liked['id_answer']; ?>&likeur=<?php echo $answer_liked['pseudo_likeur']; ?>#<?php echo $answer_liked['id_answer']; ?>">
                            <?php echo $answer_liked['pseudo_likeur']; ?>
                        </a>
                    </td>
	...
	if($donnees_new['pseudo'] != $donnees_new['last_answer_pseudo'] AND $donnees_new['last_answer_pseudo'] != NULL AND $donnees_new['vu'] == 0)
	{
		...
		?>
			...
			echo $donnees_new['nom']; ?>
                        ...
                        <td>
                            <!-- Type d'alerte -->Une nouvelle réponse est apparue ! </td>
                        <td>
                            <!-- Lien + auteur de l'alerte --><a href="index.php?action=alerts_rep&page=post&id=<?php echo $donnees_new['id_topic']; ?>&page_post=<?php echo $page; ?>&answer=<?php echo $bd[$reponse]['id']; ?>">Réponse de <?php echo $donnees_new['last_answer_pseudo']; ?></a></td>
                    </tr>
                    <?php
	}
}
