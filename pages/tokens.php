...
<div class="container">
    <?php if(isset($_GET['success']) AND $_GET['success'] == 'true'){ ?>
        <div class="alert alert-success">Votre code a bien été validé, vous avez été crédité de
            <?php echo $_Serveur_['Payement']['starpassJetons']; ?>
                <?php echo $monnaie ?>s ! </div>
        <?php } elseif(isset($_GET['success']) AND $_GET['success'] == 'false'){ ?>
            ...
            <?php } ?>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="alert alert-success">Vous pouvez payer par Dedipass, vous paierez ainsi avec votre forfait téléphonique, c'est donc un avantage important. D'un autre côté, vous serez déversé de moins de
                            <?php echo $monnaie ?>s qu'avec un payement paypal (qui sont beaucoup moins taxés).</div>
