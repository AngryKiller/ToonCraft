        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a href="index.php" class="navbar-brand">
                    <?php if ($_Theme_['All']['logo'] == "true") { ?> <img class="logo" src="theme/<?php echo $_Serveur_['General']['theme']; ?>/img/logo.png">
							...
							if(isset($_Joueur_))
								{
									...
									if($_Joueur_['rang'] == 1)
										...
										?> <a href="?&page=profil&profil=<?php echo $_Joueur_['pseudo']; ?>" class="btn btn-primary btn-block" style="margin-bottom: 5px;"><img class="icon-player-topbar" src="https://cravatar.eu/avatar/<?php echo $_Joueur_['pseudo']; ?>" width="24" height="24" /> <?php echo $_Joueur_['pseudo']; ?></a></a>
